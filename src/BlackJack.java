...
public class BlackJack {
    ...
    public void deal() {
        // deals two cards into both player and dealer hands
        deck.Deal();
        pHand.add(deck.top);
        deck.Deal();
        dHand.add(deck.top);
    ...
    public void playerTurn() {
        ...
        while (pHand.getTotalValue() < 16) {
            ...
            if (response == 'y' || response == 'Y') {
                ...
                System.out.println("and has value of: " + pHand.getTotalValue());
        ...
        public static void main (String[]args){
            ...
            //for (int i = 0; i < 25; i++) {
                ...
                System.out.println("and has value of: " + game.pHand.getTotalValue());
                ...
                // check only if player and dealer have a hand less than 21
                ...
                // resets hands back to 0 at end of game
                game.pHand.reset();
                game.dHand.reset();
